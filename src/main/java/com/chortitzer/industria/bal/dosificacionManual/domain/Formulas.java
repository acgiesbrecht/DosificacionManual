...
public class Formulas implements Serializable {
    ...
    @Column(name = "Desc1A")
    private Integer desc1A;
    @Column(name = "Desc1B")
    private Integer desc1B;
    @Column(name = "Desc1C")
    private Integer desc1C;
    @Column(name = "Desc1D")
    private Integer desc1D;
    @Column(name = "T1")
    private Integer t1;
    @Column(name = "T2")
    private Integer t2;
    ...
    public Integer getDesc1A() {
        return desc1A;
    }

    public void setDesc1A(Integer desc1A) {
        this.desc1A = desc1A;
    }

    public Integer getDesc1B() {
        return desc1B;
    }

    public void setDesc1B(Integer desc1B) {
        this.desc1B = desc1B;
    }

    public Integer getDesc1C() {
        return desc1C;
    }

    public void setDesc1C(Integer desc1C) {
        this.desc1C = desc1C;
    }

    public Integer getDesc1D() {
        return desc1D;
    }

    public void setDesc1D(Integer desc1D) {
        this.desc1D = desc1D;
    }
